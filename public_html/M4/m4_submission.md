...
<tr><td> <em>Generated: </em> 2/17/2022 1:37:53 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-010-S22/init-db-setup/grade/jbq2" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98120760/154546883-fec0afce-4222-4f76-9fd8-ef622e0c5307.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Screenshot of init_db.php served on browser.  Note that it was blocked from<br>running because the Users table was already created from running the file in<br>the past.<br></p>
</td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98120760/154547102-7bc899c9-be69-4cb2-84d5-653198dc5cd9.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Screenshot of Users table and mySQL extension in vsCode.<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>Everything I read from the SQL w3Schools links were new to me. <br>I have never done any sort of coding for databases, so I am<br>pretty excited to learn how to start making my own database and how<br>to combine it with front-end operations.  I noticed that the syntax of<br>SQL is very similar to normal sentences in English--I am slightly worried about<br>this because I feel like I will have a harder time distinguishing certain<br>keywords in SQL statements.  Everything about SQL, so far, has been quite<br>understandable.  Perhaps some topics I may need to constantly read over are<br>the list of SQL datatypes and joins.  <br></p><br></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/jbq2/IT202-010/pull/13">https://github.com/jbq2/IT202-010/pull/13</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://jbq2-prod.herokuapp.com/Project/sql/init_db.php">https://jbq2-prod.herokuapp.com/Project/sql/init_db.php</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-010-S22/init-db-setup/grade/jbq2" target="_blank">Grading</a></td></tr></table>